 ...
 *
 * Created on July 18, 2023, 12:00 PM
 */
...
int m;
void main(void) {
    ANSELD = 0x00; //inicializan en 0
    LATD = 0x00; //son digitales
    TRISD = 0X00; //Son salidas
    LATBbits.LATB0 = 0; // puerto B0 como digital
...
void __interrupt() Sleep_init(void){
    m = 0;
    INTCONbits.INT0IF = 0;//La interrupcion de bandera de desbordamiento esta deshabilitada
}
