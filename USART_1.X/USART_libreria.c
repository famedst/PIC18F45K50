 ...
 *
 * Created on July 12, 2023, 6:49 PM
 */
...
void USART_Init(long BAUD){
    //configuaracion de los pines 
    ANSELCbits.ANSC6 = 0; //RC6 es digital
    ANSELCbits.ANSC7 = 0; //RC7 es ditial
    TRISCbits.RC6 = 0; //RC6 =Tx Transmisor --> SALIDA
    TRISCbits.RC7 = 1; //RC7 =Rx Receptor --> ENTRADA
    
    SPBRG = (unsigned char)(((_XTAL_FREQ/BAUD)/64)-1);
    //Configuracion
    TXSTAbits.BRGH = 0; //LowSpeed
    TXSTAbits.SYNC = 0; //Asincrono MODE
