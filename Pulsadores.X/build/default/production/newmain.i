...
void luces_uno(void){
    LATA = 0xAA;
    if(velocidad ==1){_delay((unsigned long)((1000)*(12000000/4000.0)));LATA = 0x00;_delay((unsigned long)((1000)*(12000000/4000.0)));}
    else if(velocidad ==2){_delay((unsigned long)((500)*(12000000/4000.0)));LATA = 0x00;_delay((unsigned long)((500)*(12000000/4000.0)));}
    else if(velocidad ==3){_delay((unsigned long)((250)*(12000000/4000.0)));LATA = 0x00;_delay((unsigned long)((250)*(12000000/4000.0)));}
    else if(velocidad ==4){_delay((unsigned long)((100)*(12000000/4000.0)));LATA = 0x00;_delay((unsigned long)((100)*(12000000/4000.0)));}
    if(PORTCbits.RC1 == 1){
